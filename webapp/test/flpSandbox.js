		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commigracionportalproveedores-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commigracionportalproveedores-display": {
								"semanticObject": "commigracionportalproveedores",
								"action": "display",
								"description": "Migracion Portal Proveedores",
								"title": "Portal Proveedores",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.migracion.portalproveedores",
									"url": sap.ui.require.toUrl("com/migracion/portalproveedores")
								}
							}
						}
					}
